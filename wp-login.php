...
<script type="text/javascript" src="wp-content/plugins/si-captcha-for-wordpress/captcha/si_captcha.js?ver=1342105158"></script>
...
<p class="cptch_block"><br />    OATH_OTP(158):<input type="text" name="cptch_number" tabindex="30" value="" maxlength="10" size="1" style="width:100px;margin-bottom:0;display:inline;" /><br />	<input type="hidden" name="cptch_result" value=" " /><input type="hidden" value="Version: 0.0.1" />
